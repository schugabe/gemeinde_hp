...
FLIPBOOK.PageWebGL.prototype.load = function () {
	...
	texture = THREE.ImageUtils.loadTexture(self.frontTexture, null, function(){
		//front loaded
		self.mats[self.sides.front] = self.createMaterial(self.materialType, texture);
		//load back
		texture = THREE.ImageUtils.loadTexture(self.backTexture, null, function(){
			//back loaded
...
FLIPBOOK.BookWebGL.prototype.createPages = function(){
	...
	var preloader = THREE.ImageUtils.loadTexture(this.options.assets.preloader, null, function(){
...
//
// console.log(this.zoom, this.options.zoom)
    e.preventDefault();
    var vector = this._getVector(e);
